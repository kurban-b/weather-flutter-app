            ...
            return Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text(
                      '${DateFormat('dd.MM.yyyy').format(DateTime.fromMillisecondsSinceEpoch(snapshot.data!.list[0]['dt'] * 1000))}',
                      style:
                ...
                Row(
                  ...
                  children: [
                    Text(
                      '${DateFormat('hh:mm').format(DateTime.fromMillisecondsSinceEpoch(snapshot.data!.list[0]['dt'] * 1000))}',
                      style:
                          TextStyle(fontSize: 50, fontWeight: FontWeight.bold),
                    ),
                  ],
